...
write.csv(res_ancg_b, "data/corrplot/ancg_b.csv")
write.csv(res_ancg_m, "data/corrplot/ancg_m.csv")
write.csv(res_ancg_s, "data/corrplot/ancg_s.csv")
write.csv(res_nacc_b, "data/corrplot/nacc_b.csv")
write.csv(res_nacc_m, "data/corrplot/nacc_m.csv")
write.csv(res_nacc_s, "data/corrplot/nacc_s.csv")
write.csv(res_dlpfc_b, "data/corrplot/dlpfc_b.csv")
write.csv(res_dlpfc_m, "data/corrplot/dlpfc_m.csv")
write.csv(res_dlpfc_s, "data/corrplot/dlpfc_s.csv")
